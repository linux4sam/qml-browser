#ifndef MYDECLARATIVEWEBVIEW_H
#define MYDECLARATIVEWEBVIEW_H
...
class QDeclarativeWebPage : public QWebPage {
    Q_OBJECT
public:
    explicit QDeclarativeWebPage(MyQDeclarativeWebView *parent);
    ~QDeclarativeWebPage();
protected:
...
private:
    MyQDeclarativeWebView *viewItem();
};

class GraphicsWebView : public QGraphicsWebView {
    Q_OBJECT
public:
    GraphicsWebView(MyQDeclarativeWebView* parent = 0);
protected:
...
public:
    MyQDeclarativeWebView(QDeclarativeItem *parent = 0);
    ~MyQDeclarativeWebView();
...
private Q_SLOTS:
    ...
    MyQDeclarativeWebView* createWindow(QWebPage::WebWindowType type);
...
private:
    ...
    Q_DISABLE_COPY(MyQDeclarativeWebView)
...
QML_DECLARE_TYPE(MyQDeclarativeWebView)
QML_DECLARE_TYPE(QDeclarativeWebSettings)
QML_DECLARE_TYPEINFO(MyQDeclarativeWebView, QML_HAS_ATTACHED_PROPERTIES)

QT_END_HEADER

#endif // MYDECLARATIVEWEBVIEW_H
